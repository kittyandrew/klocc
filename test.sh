...
: '
  ...
  $ curl -sX POST -H "Content-Type: application/json" -d "{\"username\": \"kittyandrew\", \"reponame\": \"klocc\", \"provider\": \"github\"}" http://0.0.0.0:8080/api/jobs
...
...     "message_code": "info_success_generated",
...     "status": 200,
...     "data": {
